...
console.log("=== RUNNING SCENARIO TESTS (NO EROSION) ===");
runScenario(340, 0.70, 8, 17, 150, 3, 250, 16, 500, 50); // Defaults
runScenario(340, 0.50, 8, 17, 150, 3, 250, 16, 500, 50); // Low opt-out (more kids)
runScenario(600, 0.30, 8, 17, 150, 3, 250, 16, 500, 50); // High cost scenario
